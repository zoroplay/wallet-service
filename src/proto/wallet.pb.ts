...
export interface TigoPayoutRequest {
  userId: number;
  clientId: number;
  amount: number;
  username: string;
...
export interface TigoPayoutResponse {
  success: boolean;
  status: number;
  message: string;
}
...
export interface WalletServiceClient {
  ...
  tigoPayout(request: TigoPayoutRequest): Observable<TigoPayoutResponse>;
...
export interface WalletServiceController {
  ...
  tigoPayout(
    request: TigoPayoutRequest,
  ): Promise<TigoPayoutResponse> | Observable<TigoPayoutResponse> | TigoPayoutResponse;
